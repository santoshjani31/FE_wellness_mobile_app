...
// Create a journal subcollection for the user (after user document is created)
          await FirebaseFirestore.instance
              .collection('users')
              .doc(uid)
              .collection('journal')
              .add({ "body": "Add a new entry",
          "emotion": "happy",
          "title": "New Title"});

          Navigator.pushReplacement(
            context,
            MaterialPageRoute(builder: (context) => MoodsPage(userId: uid)),
          );
        } else {
